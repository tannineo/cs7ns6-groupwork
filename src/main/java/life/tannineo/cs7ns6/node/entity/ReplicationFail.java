...
public class ReplicationFail {
    ...
    public ReplicationFail(Callable callable, LogEntry logEntry, Peer peer, Long offerTime) {
    ...
    private ReplicationFail(Builder builder) {
    ...
    public static final class Builder {
        ...
        public ReplicationFail build() {
            return new ReplicationFail(this);
        }
    }
}
